"""
Contains model structure for pre-training.
"""
# coding=utf-8
...
class SegmentationHead(nn.Sequential):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=3, upsampling=1): # inchannel = 16, outchannel = 7
...
class VisionTransformer(nn.Module):
    def __init__(self, config, img_size=224, num_classes=21843, zero_head=False, vis=False):
        ...
        self.FinalDecoder = FinalDecoder(config['decoder_channels'][-1], 1)
